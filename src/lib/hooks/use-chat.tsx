...
import { api as duliaAPI } from '../api'
...
const getStreamedResponse = async (
  ...
  while (true) {
    ...
    await mutate([...chatRequest.messages, { ...responseMessage }], false)
...
export function useChat({
  ...
  // Store the chat state in SWR, using the appId and chatId as the key to share states.
  const { data, mutate } = useSWR<Message[]>([appId, chatId], null, {
